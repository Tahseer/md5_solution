(function (global) {
  ...
  // Build HTML for the categories page based on data from the server
  ...
  // Build HTML for the menu items page based on data from the server
...
// Randomly selects a category and loads the menu items view for that category
